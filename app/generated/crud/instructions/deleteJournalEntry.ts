...
import { findJournalEntryPda } from "../pdas";
...
>(
  input: DeleteJournalEntryAsyncInput<TAccountJournalEntry, TAccountOwner>,
...
> {
  ...
  if (!accounts.journalEntry.value) {
    accounts.journalEntry.value = await findJournalEntryPda({
      title: expectSome(args.title),
...
export function getDeleteJournalEntryInstruction<
  ...
  TProgramAddress extends Address = typeof CRUD_PROGRAM_ADDRESS,
>(
  input: DeleteJournalEntryInput<TAccountJournalEntry, TAccountOwner>,
  config?: { programAddress?: TProgramAddress },
): DeleteJournalEntryInstruction<
  TProgramAddress,
  TAccountJournalEntry,
...
>(
  ...
  return {
    ...
    accounts: { journalEntry: getNextAccount(), owner: getNextAccount() },
